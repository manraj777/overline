...
export default function MyProfileScreen() {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      await staffApi.updateMe({ name, phone });
      await checkAuth();
          ...
          <View style={styles.section}>
            ...
            <View style={styles.card}>
              ...
              <SettingItem 
                ...
                color="#F59E0B" 
                onPress={() => Alert.alert('Support Info', 'Please contact support@overline.in for platform inquiries.')}
              />
            </View>
          </View>
              ...
              <ScrollView contentContainerStyle={{ padding: 24 }}>
                ...
                <View style={styles.inputGroup}>
                  ...
                  <View style={[styles.inputBox, { backgroundColor: '#F1F5F9' }]}>
                    ...
                    <TextInput style={[styles.textInput, { color: '#94A3B8' }]} value={email} editable={false} />
                  </View>
                </View>
...
const styles = StyleSheet.create({
  ...
  inputBox: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F8FAFC', borderRadius: 16, paddingHorizontal: 16, height: 56, borderWidth: 1, borderColor: '#F1F5F9' },
